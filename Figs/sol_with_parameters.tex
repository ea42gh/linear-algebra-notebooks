...
$\begin{NiceArray}[create-medium-nodes]{*3r@{\qquad\ }*3rI*1r@{\qquad\;\;}r}
% --------------------------------------------
 &   &   & 1 & 2 & 4 & 1 &  \\ 
 &   &   & 2 & k & 8 & h &  \\ 
 &   &   & 3 & 7 & 3 & 1 &  \\ \noalign{\vskip2mm} 
...
\begin{tikzpicture}
    ...
    \node [draw,blue,fit = (10-4)]  {} ;
    \node [draw,red,fit = (8-5)]  {} ;
    \node [draw,blue,fit = (11-5)]  {} ;
    \node [draw,red,fit = (12-6)]  {} ;
    \end{scope}

% ----------------------------------------- explanatory text
    \node [right,align=left] at (1-7.east)  {\quad \quad Pivot at (1,1) } ;
    \node [right,align=left] at (4-7.east)  {\quad \quad Rows 2 <-> 3 } ;
    \node [right,align=left] at (7-7.east)  {\quad \quad Pivot at (2,2) } ;
    \node [right,align=left] at (10-7.east)  {\quad \quad In Row Echelon Form } ;

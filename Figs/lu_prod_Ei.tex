...
% --------------------------------------------
       ...
       &       &       &       & \color{red}{ 1 }   &   1   &   0   &   0   &   0    & \color{red}{ 1}   &   0   &   0   &   0    &   1   &  \color{red}{0}   &   0   &   \\
       &       &       &       & \color{red}{ -1}   &   0   &   1   &   0   &   0    & \color{red}{ 1}   &   1   &   0   &   0    &   0   &  \color{red}{1}   &   0   &   \\
       &       &       &       & \color{red}{ -2}   &   0   &   0   &   1   &   0    & \color{red}{ 1}   &   0   &   1   &   0    &   0   &  \color{red}{2}   &   1   &   \\ \noalign{\vskip2mm}
% --------------------------------------------
   1   &   0   &   0   &   0   & \color{red}{ 1 }   &   0   &   0   &   0   &  \color{blue}{ 1 }   & \color{red}{ 0}   &   0   &   0   &  \color{blue}{ 1 }   & \color{blue}{  0 }  &  \color{red}{0}   &   0   &   \\
   0   &   1   &   0   &   0   & \color{red}{ -1}   &   1   &   0   &   0   &  \color{blue}{ 1 }   & \color{red}{ 1}   &   0   &   0   &  \color{blue}{ 1 }   & \color{blue}{  1 }  &  \color{red}{0}   &   0   &   \\
   0   &   0   &   1   &   0   & \color{red}{ 1 }   &   0   &   1   &   0   &  \color{blue}{ -1}   & \color{red}{ 1}   &   1   &   0   &  \color{blue}{ -1}   & \color{blue}{  1 }  &  \color{red}{1}   &   0   &   \\
   0   &   0   &   0   &   1   & \color{red}{ 2 }   &   0   &   0   &   1   &  \color{blue}{ -2}   & \color{red}{ 1}   &   0   &   1   &  \color{blue}{ -2}   & \color{blue}{  1 }  &  \color{red}{2}   &   1   &
\CodeAfter

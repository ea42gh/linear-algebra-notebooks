...
$\begin{NiceArray}[create-medium-nodes]{*3r@{\qquad\ }*3r@{\qquad\ }*3rI*3r@{\qquad\;\;}r}
 & & & & & &   1 & 2 & -1 &   1 & 3 & -2 &  \\ 
 & & & & & &   1 & 1 & 1 &   1 & 1 & 4 &  \\ 
 & & & & & &   2 & 0 & -1 &   2 & -2 & -1 &  \\  \noalign{\vskip2mm} 
 & & &   1 & 1 & 2 &   6 & 3 & -2 &   6 & 0 & 0 &  \\ 
 & & &   3 & 1 & -2 &   0 & 7 & 0 &   0 & 14 & 0 &  \\ 
 & & &   -2 & 4 & -1 &   0 & 0 & 7 &   0 & 0 & 21 &  \\  \noalign{\vskip2mm} 
\frac{\sqrt{6}}{6} & 0 & 0 &   \frac{\sqrt{6}}{6} & \frac{\sqrt{6}}{6} & \frac{\sqrt{6}}{3} &   \sqrt{6} & \frac{\sqrt{6}}{2} & - \frac{\sqrt{6}}{3} & & &    &  \\ 
0 & \frac{\sqrt{14}}{14} & 0 &   \frac{3 \sqrt{14}}{14} & \frac{\sqrt{14}}{14} & - \frac{\sqrt{14}}{7} &   0 & \frac{\sqrt{14}}{2} & 0 & & &    &  \\ 
0 & 0 & \frac{\sqrt{21}}{21} &   - \frac{2 \sqrt{21}}{21} & \frac{4 \sqrt{21}}{21} & - \frac{\sqrt{21}}{21} &   0 & 0 & \frac{\sqrt{21}}{3} & & &    & 
\CodeAfter

...
\fill[line width=0.6pt,color=la_gray,fill=la_gray,fill opacity=0.3] (-8,3) -- (6,9) -- (12,9) -- (-2,3) -- cycle;
...
\draw [line width=0.6pt,color=black] (-2,3) -- (12,9) -- (8,3);
...
\draw [color=black] (-2,3) -- (-8,3)-- (0,0);
\draw [color=black] (6,0)-- (-2,3);

% ---------------------------------------------  Vectors and Vector Labels
\draw [line width=0.4mm,>=stealth,->] (0,0) -- (-8,3);
\draw [line width=0.4mm,>=stealth,->] (-8,3) -- (6,9);
\draw [line width=0.4mm,>=stealth,->] (0,0) -- (6,0);
\draw [line width=0.4mm,>=stealth,->] (0,0) -- (6,9);


\draw[color=black] (3,-0.3)     node {\Large $a$};
\draw[color=black] (-5,1.5)     node {\Large $b$};
\draw[color=black] (0,6.8) node {\Large $c$};
\draw[color=black] (1.5,3.5) node {\Large $b+c$};

\draw[color=black] (-2.5,2) node {\Large $a \wedge b$}; \draw[thick,color=black,>=stealth,->] (-3,1.7) arc (-160:125:0.6);
\draw[color=black] (0,5) node {\Large $a \wedge c$};    \draw[thick,color=black,>=stealth,->] (-0.5,4.7) arc (-160:125:0.6);
\draw[color=black] (6,4) node {\Large $a \wedge (b+c)$};\draw[thick,color=black,>=stealth,->] (5.1,3.7) arc (-160:125:1.1);

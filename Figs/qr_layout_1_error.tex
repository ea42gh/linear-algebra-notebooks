...
$\begin{NiceArray}[create-medium-nodes]{*2r@{\qquad\ }*3r@{\qquad\ }*3rI*2r@{\qquad\;\;}r}
 & & & & &   1 & 2 & -1 &   1 & 3 &  \\ 
 & & & & &   1 & 1 & 1 &   1 & -1 &  \\ 
 & & & & &   2 & 0 & -1 &   2 & -2 &  \\  \noalign{\vskip2mm} 
 & &   1 & 1 & 2 &   6 & 3 & -2 &   6 & -2 &  \\ 
 & &   3 & -1 & -2 &   -2 & 5 & -2 &   -2 & 14 &  \\  \noalign{\vskip2mm} 
\frac{\sqrt{70}}{20} & \frac{1}{40} &   \frac{3}{40} + \frac{\sqrt{70}}{20} & - \frac{1}{40} + \frac{\sqrt{70}}{20} & - \frac{1}{20} + \frac{\sqrt{70}}{10} &   - \frac{1}{20} + \frac{3 \sqrt{70}}{10} & \frac{1}{8} + \frac{3 \sqrt{70}}{20} & - \frac{\sqrt{70}}{10} - \frac{1}{20} & &    &  \\ 
\frac{1}{40} & \frac{\sqrt{30}}{20} &   \frac{1}{40} + \frac{3 \sqrt{30}}{20} & \frac{1}{40} - \frac{\sqrt{30}}{20} & \frac{1}{20} - \frac{\sqrt{30}}{10} &   \frac{3}{20} - \frac{\sqrt{30}}{10} & \frac{3}{40} + \frac{\sqrt{30}}{4} & - \frac{\sqrt{30}}{10} - \frac{1}{20} & &    & 
\CodeAfter

...
$\begin{NiceArray}[create-medium-nodes]{*2r@{\qquad\ }*4r@{\qquad\ }*2rI*2r@{\qquad\;\;}r}
 ...
 & &   1 & 1 & 1 & 2 &   7 & -1 &   7 & 0 &  \\ 
 & &   8 & 8 & -6 & -5 &   0 & 27 &   0 & 189 &  \\  \noalign{\vskip2mm} 
\frac{\sqrt{7}}{7} & 0 &   \frac{\sqrt{7}}{7} & \frac{\sqrt{7}}{7} & \frac{\sqrt{7}}{7} & \frac{2 \sqrt{7}}{7} &   \sqrt{7} & - \frac{\sqrt{7}}{7} & &    &  \\ 
0 & \frac{\sqrt{21}}{63} &   \frac{8 \sqrt{21}}{63} & \frac{8 \sqrt{21}}{63} & - \frac{2 \sqrt{21}}{21} & - \frac{5 \sqrt{21}}{63} &   0 & \frac{3 \sqrt{21}}{7} & &    & 
\CodeAfter

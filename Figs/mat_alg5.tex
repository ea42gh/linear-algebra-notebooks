...
$\begin{NiceArray}[create-medium-nodes]{r@{\qquad\ }r@{\qquad\ }r}
% -------------------------------------------- 
  &       &       \\
  &       &       \\
  &       &       \\
...
% ----------------------------------------- submatrix delimiters
  \SubMatrixOptions{right-xshift=2mm, left-xshift=2mm}
                           \SubMatrix({5-2}{5-2}) \SubMatrix({5-3}{5-3})
    \SubMatrix({6-1}{6-1}) \SubMatrix({6-2}{6-2}) \SubMatrix({6-3}{6-3})
    % ----------------------------------------- pivot outlines
%\begin{tikzpicture}
...
$\begin{NiceArray}[create-medium-nodes]{*3r@{\qquad\ }*2r@{\qquad\ }*4r}
% -------------------------------------------- 
  &   &   &    3 & 1   &   &   &   &    \\
  &   &   &    0 & 1   & 2 & 2 & 1 & 1  \\
  &   &   &    2 & 2   &-2 &-1 & 0 & 1  \\  \noalign{\vskip2mm}
% -----------------------------------
1 & 2 & 2 &    7 & 7   & 0 & 7 & 7 & 0  \\
2 & 0 & 3 &   12 & 8   & 8 &16 &12 & 4 
\CodeAfter
% ----------------------------------------- submatrix delimiters
  \SubMatrixOptions{right-xshift=2mm, left-xshift=2mm}
                           \SubMatrix({1-4}{3-5}) \SubMatrix({2-6}{3-9})
    \SubMatrix({4-1}{5-3}) \SubMatrix({4-4}{5-5}) \SubMatrix({4-6}{5-9})
    % ----------------------------------------- pivot outlines
%\begin{tikzpicture}
%    \begin{scope}[every node/.style = draw]
%    \end{scope}

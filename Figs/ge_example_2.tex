...
0 & 0 & 1 & 0 & 0 & 0 & 0 & 0 & 0 & 3 & 
        ...
        % ----------------------------------------- explanatory text
            ...
            \node [right,align=left] at (9-10.east)  {\quad \quad R3 reads 0 = 3; CONTRADICTION } ;
            \node [right,align=left] at (13-10.east)  {\quad \quad Pivot in the b column: CONTRADICTION} ;

...
$\begin{NiceArray}[create-medium-nodes]{*3r@{\qquad\ }*3r@{\qquad\;\;}r}
% --------------------------------------------
 &   &   & 1 & 2 & 1 &  \\ 
 &   &   & 2 & 4 & 4 &  \\ 
 &   &   & 0 & 1 & 1 &  \\ \noalign{\vskip2mm} 
...
% ----------------------------------------- explanatory text
    \node [right,align=left] at (1-6.east)  {\quad \quad A } ;
    \node [right,align=left] at (4-6.east)  {\quad \quad $A_1 = E_1 A$ } ;
    \node [right,align=left] at (7-6.east)  {\quad \quad $A_2 = E_2 E_1 A$ } ;
    \node [right,align=left] at (10-6.east)  {\quad \quad $A_3 = E_3 E_2 E_1 A$ } ;

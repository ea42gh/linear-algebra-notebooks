...
$\begin{NiceArray}[create-medium-nodes]{*4r@{\qquad\ }*4r@{\qquad\ }*4r@{\qquad\ }*4r@{\qquad\;\;}r}
% --------------------------------------------
&   &   &   & \color{red}{1  } & 0 & 0 & 0 & 1  & \color{red}{0 } & 0 & 0 & 1  & 0  & \color{red}{0} & 0 & \\
&   &   &   & \color{red}{2  } & 1 & 0 & 0 & 0  & \color{red}{1 } & 0 & 0 & 0  & 1  & \color{red}{0} & 0 & \\
&   &   &   & \color{red}{-4 } & 0 & 1 & 0 & 0  & \color{red}{1 } & 1 & 0 & 0  & 0  & \color{red}{1} & 0 & \\
&   &   &   & \color{red}{3  } & 0 & 0 & 1 & 0  & \color{red}{-2} & 0 & 1 & 0  & 0  & \color{red}{1} & 1 & \\ \noalign{\vskip2mm}
% --------------------------------------------
1 & 0 & 0 & 0 & \color{red}{1 } & 0 & 0 & 0 & \color{blue}{1 } & \color{red}{0 } & 0 & 0 & \color{blue}{1 } & \color{blue}{0 } & \color{red}{0} & 0 & \\
0 & 1 & 0 & 0 & \color{red}{2 } & 1 & 0 & 0 & \color{blue}{2 } & \color{red}{1 } & 0 & 0 & \color{blue}{2 } & \color{blue}{1 } & \color{red}{0} & 0 & \\
0 & 0 & 1 & 0 & \color{red}{-4} & 0 & 1 & 0 & \color{blue}{-4} & \color{red}{1 } & 1 & 0 & \color{blue}{-4} & \color{blue}{1 } & \color{red}{1} & 0 & \\
0 & 0 & 0 & 1 & \color{red}{3 } & 0 & 0 & 1 & \color{blue}{3 } & \color{red}{-2} & 0 & 1 & \color{blue}{3 } & \color{blue}{-2} & \color{red}{1} & 1 & \\
\CodeAfter
